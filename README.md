...
See [REPOSITORY-DIFFERENTIATION.md](REPOSITORY-DIFFERENTIATION.md) for the intended position relative to existing tools.
...
See [docs/RELEASING.md](docs/RELEASING.md) for npm trusted-publishing bootstrap and versioned release steps.
